...
{
    [ObservableProperty] private TerminalViewModel _a = null!;
    ...
    [ObservableProperty] private TerminalViewModel _b = null!;
    ...
    [ObservableProperty] private TerminalViewModel _cin = null!;
    ...
    [ObservableProperty] private TerminalViewModel _sum = null!;
    ...
    [ObservableProperty] private TerminalViewModel _cout = null!;
    ...
    public FullAdderViewModel() : this(new FullAdder()) { }
    private FullAdderViewModel(FullAdder model) : base(model)
    {
        Width = 40;
        Height = 60;
    }
    ...
    {
        if (A is null || B is null || Cin is null || Sum is null || Cout is null) return;
