...
public abstract partial class CircuitObjectViewModel(CircuitObject model)
    : ObservableObject,
        ISimulatable
{
    [ObservableProperty]
    ...
    [ObservableProperty]
    [property: JsonIgnore]
    private double _selectionOpacity = 0.0;
    ...
    [JsonIgnore]
    public bool IsSelected = false; // keeps track of selection
