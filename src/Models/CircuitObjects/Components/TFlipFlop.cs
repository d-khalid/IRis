...
public class TFlipFlop : Component
{
    public Terminal T = null!;
    ...
    public override void Simulate()
    {
        ...
        if (T.State == LogicState.Unknown || Clk.State == LogicState.Unknown)
        {
        ...
        if (
            _lastClk == LogicState.Low
            && Clk.State == LogicState.High
